...
class T5IntentClassSlotFillEncoderOnly(T5PreTrainedModel):
    """
    A model based on the T5 Encoder for joint intent classification and slot filling
    ...
    def __init__(self, config, intent_label_dict, slot_label_dict):
        ...
        self.t5 = T5EncoderModel(config=config)  # Load pretrained t5 encoder
